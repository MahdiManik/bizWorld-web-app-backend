...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    document: Schema.Attribute.Media<"images" | "videos" | "audios" | "files">;
...
export interface ApiListingListing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    askingPrice: Schema.Attribute.String & Schema.Attribute.Required;
    businessOwner: Schema.Attribute.Relation<
      "manyToOne",
      "plugin::users-permissions.user"
    >;
    ...
    > &
      Schema.Attribute.DefaultTo<"ECOMMERCE">;
    ...
    document: Schema.Attribute.Media<
      ...
      true
    >;
    ebitda: Schema.Attribute.String;
    ebitdaYoY: Schema.Attribute.String;
    employees: Schema.Attribute.String;
    equityOffered: Schema.Attribute.String;
    established: Schema.Attribute.String;
    growthRate: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    marginYoY: Schema.Attribute.String;
    monthlyFinancials: Schema.Attribute.JSON;
    profitMargin: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    revenueYoY: Schema.Attribute.String;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<
      ["SMALL_BUSINESS", "STARTUP", "FRANCHISE"]
    > &
      Schema.Attribute.DefaultTo<"SMALL_BUSINESS">;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    visibility: Schema.Attribute.String & Schema.Attribute.DefaultTo<"Private">;
  };
}
...
export interface ApiSubscriptionSubscription
  ...
  attributes: {
    ...
    planType: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiUserProfileUserProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    areasOfExpertise: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    document: Schema.Attribute.Media<"images" | "videos" | "audios" | "files">;
    image: Schema.Attribute.Media<"images">;
    industrySpecialization: Schema.Attribute.String;
    ...
    professionalHeadline: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    users_permissions_user: Schema.Attribute.Relation<
      ...
      "plugin::users-permissions.user"
    >;
    whatsup: Schema.Attribute.String;
  };
}
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    consultantData: Schema.Attribute.JSON;
    consultantStatus: Schema.Attribute.Enumeration<
      ["NONE", "PENDING", "CONSULTANT"]
    > &
      Schema.Attribute.DefaultTo<"NONE">;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> &
      Schema.Attribute.Private;
    documentCv: Schema.Attribute.Media<"files">;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    investerStatus: Schema.Attribute.Enumeration<["PENDING", "INVESTER"]> &
      Schema.Attribute.DefaultTo<"PENDING">;
